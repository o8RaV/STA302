...
author: 
  - Raghav Kanda
thanks: "Code and data are available at: https://github.com/o8RaV/STA302/tree/main/Donaldson%20Paper"
...
To ensure the accuracy and reliability of the dataset, a meticulous data cleaning process was undertaken. This involved removing any inconsistencies, errors, or missing values within the dataset. Transformations and adjustments were implemented as needed to create a cohesive and standardized dataset for analysis. The goal was to present a refined dataset that aligns with the research objectives and facilitates meaningful insights.
...
Gelfand, Sharla. 2022. Opendatatoronto: Access the City of Toronto Open Data Portal. [CRAN Link](https://cran.r-project.org/package=opendatatoronto).

Wickham, Hadley. 2016. Ggplot2: Elegant Graphics for Data Analysis. Springer-Verlag New York. [ggplot2 Link](https://ggplot2.tidyverse.org/).

Wickham, Hadley, and Kirill Müller. 2023. Tibble: Simple Data Frames.

Wickham, Hadley, Romain François, Lionel Henry, and Kirill Müller. 2023. Dplyr: A Grammar of Data Manipulation. [CRAN Link](https://cran.r-project.org/package=dplyr).

Wickham, Hadley, Jim Hester, and Jennifer Bryan. 2023. Readr: Read Rectangular Text Data. [CRAN Link](https://cran.r-project.org/package=readr).

Xie, Yihui. 2014. Knitr: A Comprehensive Tool for Reproducible Research in R. [Book Link](http://www.crcpress.com/product/isbn/9781466561595).

Clarke, Erik, and Scott Sherrill-Mix. 2023. “Ggbeeswarm: Categorical Scatter (Violin Point) Plots.” [CRAN Link](https://cran.r-project.org/web/packages/ggbeeswarm/index.html).

Zhu, Hao. 2021. kableExtra: Construct Complex Table with ’Kable’ and Pipe Syntax. [CRAN Link](https://cran.r-project.org/package=kableExtra).